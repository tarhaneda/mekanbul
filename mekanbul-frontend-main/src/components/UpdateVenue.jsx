...
const UpdateVenue = () => {
        ...
        VenueDataService.getVenue(id)
            .then((response) => {
                ...
                setVenue({
                    ...
                    lat: v.coordinates ? v.coordinates[1] : "",
                    long: v.coordinates ? v.coordinates[0] : "",
                    hours: hoursData
                });
            })
            .catch((e) => {
    ...
    const updateVenue = (e) => {
        ...
        VenueDataService.updateVenue(id, data, user.token)
            .then((response) => {
                navigate("/admin");
            })
            .catch((e) => {
        ...
        <>
            ...
            <div className="container mt-5">
                ...
                <form onSubmit={updateVenue}>
                    ...
                    <button type="submit" className="btn btn-warning">Güncelle</button>
                </form>
            </div>
        </>
    );
